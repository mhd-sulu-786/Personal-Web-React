    ...
    <Container fluid style={{ width: '100%' }}>
      ...
      <Container fluid>
        <Container className='flexs-row gap-3'>
          ...
          <div className="col-md-6 p-4 rounded mt-3 border border-2 border-success" style={{ backgroundColor: '#FFFFFF' }}>
      ...
      <footer className='w-100 mx-0 p-1 mt-3'>
        <Container>
          ...
          <div className='d-flex justify-content-center'>
            ...
            <Button href='https://twitter.com/' className='hover-logo-icon mx-1'><TwitterIcon /></Button>
            <Button href='https://github.com/' className='hover-logo-icon mx-1'><GitHubIcon /></Button>
